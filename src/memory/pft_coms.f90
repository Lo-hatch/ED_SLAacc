...
!---------------------------------------------------------------------------------------!
   !     This variable is provided by the user through namelist, and contains the list of  !
   ! PFTs pf which SLA acclimate with CO2                                                          !
   !---------------------------------------------------------------------------------------!
   integer, dimension(n_pft) :: include_these_pft_sla
   ...
   !    This is the list of PFTs that are included.  0 means off, 1 means on.              !
   !---------------------------------------------------------------------------------------!
   logical, dimension(n_pft) :: include_pft_sla
   ...
   !---------luzihan, 20222.12.7 ---------------------------------!
   real   , dimension(n_pft)    :: kplastic_ref_lai ! Expansion factor for SLA
