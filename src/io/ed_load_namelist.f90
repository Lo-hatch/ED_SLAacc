...
subroutine copy_nl(copy_type)
   ...
   use pft_coms             , only : include_these_pft         & ! intent(out)
                                   ,include_these_pft_sla      & ! intent(out)
   ...
   case ('ALL_CASES')
      ...
      include_these_pft_sla   = nl%include_these_pft_sla
   ...
   !---------------------------------------------------------------------------------------!
  !----- Sort up the chosen PFTs. --------------------------------------------------------!
   where (include_these_pft_sla < 1 .or. include_these_pft_sla > n_pft)
      include_these_pft_sla = skip_integer
   end where
   call sort_up(include_these_pft_sla,n_pft)
