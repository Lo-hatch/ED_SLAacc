...
! allocation variables
           ...
           !---------------------luzihan 2022/12/7-----------------!
           call getConfigREAL  ('kplastic_ref_lai','pft',i,rval,texist)
           if(texist) kplastic_ref_lai(myPFT) = sngloff(rval,tiny_offset)
...
!! ALLOCATION
        ...
        !---------------------luzihan 2022/12/7----------------------!
         call putConfigREAL("kplastic_ref_lai"   ,kplastic_ref_lai   (i))
